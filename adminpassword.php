...
<dd><input type="password" id="old_password" name="old_password"  value="" required ></dd></dl><br><br><br>
<dl><dt>New Password</dt>
<dd><input type="password" id="new_password" name="new_password"  value=""  required></dd></dl><br><br><br>
<dl><dt>Retype New Password</dt>
<dd><input type="password" id="con_password" name="con_password"  value="" required ></dd></dl><br><br>
<input style="margin-left: 150px; " type="checkbox"  name="reveal" id="reveal" onchange="reveal_pass(this);">Show Password?<br>
...
{
        var textbox_elem = document.getElementById("old_password");
   ...
   var textbox_elem = document.getElementById("new_password");
...
var textbox_elem = document.getElementById("con_password");
