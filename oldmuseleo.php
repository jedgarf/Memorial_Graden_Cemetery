...
<form action="saveoldmuseleo.php" method="get">
  ...
  $D_id = $_GET['D_id'];
    ...
    echo"<input type='text' placeholder='Lastname' name='D_lastname'  required><br>";

     echo"<label><b>Firstname</b><br>";
    echo"<input type='text' placeholder='Firstname' name='D_firstname'  required><br><br>";

      
    echo"<input type='text'  placeholder='Middle Name' id='middle' name='D_middle'  required>";
