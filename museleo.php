  ...
  <div class="sidebar">
    ...
    <li><a  href="adminpage.php"><i class="fa fa-home fa-fw" aria-hidden="true"></i>&nbsp; Home</a></li>
     <li><a href="appartment.php"><i class="fa fa-list-ol fa-fw" aria-hidden="true"></i>&nbsp; Appartment</a></li>
      <li><a href="museleo.php" class="selected"><i class="fa fa-list-ol fa-fw" aria-hidden="true"></i>&nbsp; Museleo</a></li>
...
<div class="print">
  ...
  <div id="openModal1" class="modalDialog1">
              ...
              <a href="#close1" title="Close" class="close1">X</a>
               ...
               <form id="add" name="add" method="get" action="saveareamuseleo.php">
 ...
 <div class="text">
   <input name="a_number" maxlength="2" onkeypress="return isNumberKey(event)" type="text" id="a_number" placeholder="Area No" required></div><br><br>
              ...
              <a href="#close18" title="Close" class="close18">X</a>
               ...
               <center>
               <form id="add" name="add" method="get" action="saveslotmuseleo.php">
                
<div class="styled-select">
 <select name="s_type" required>
 <option value="">Type of Lot</option>
 <option value="museleo">Museleo</option>
 <option value="Family lot">Family Lot</option>
 <option value="Appartment">Appartment</option>
 </select></div>

 <div class="text">
   <input name="s_number" onkeypress="return isNumberKey(event)" maxlength="4"  type="text" id="s_number" placeholder="Slot No" required></div><br><br>
                  <p>
                <label>
                <center>
...
<!-- The Modal -->
                ...
                <div>
                <h2 class="headerarea">Museleo</h2>
  ...
  <div class="area1">
   ...
   <form id="add" name="add" method="get" action="savemuseleo.php">
...
<div class="styled-select1">
 ...
 <input type="hidden" name="D_type" value="museleo">
  <div class="styled-select1">
   <select name="s_number" required>
    <option value="">Slot No.</option>
  <?php
  include("connection3.php");
        $q = mysqli_query($con,"SELECT * from slot_table where s_type='museleo'");
      while($row=mysqli_fetch_array($q)){
...
<center>
   <table border="1" cellpadding="0" cellspacing="0" id="resultTable">
          <thead>
            <th class="th" colspan='8'>Museleo</th>
            <tr>
...
while($row = mysql_fetch_assoc($select))
{
    ...
    echo "<td> " . $row["D_slot_number"]. " <a href='oldmuseleo.php?D_id=".$row['D_id']."' style='text-decoration:none' class='link3' ><i class='fa fa-user-plus fa-fw' aria-hidden='true'></td>";
...
echo "<td><a href='editmuseleo.php?D_id=".$row['D_id']."' style='text-decoration:none' class='link3' ><i class='fa fa-edit fa-fw' aria-hidden='true'></i></a></td>";
echo "<td><a href='printonemuseleo.php?D_id=".$row['D_id']."' style='text-decoration:none' class='link2'  target='blank'><i class='fa fa-print fa-fw' aria-hidden='true'></i></a></td>";
echo "</tr>";
