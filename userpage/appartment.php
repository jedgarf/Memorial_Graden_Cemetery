...
<br>
</label><input name="D_middle"  onKeyPress="return ValidateAlpha(event);" type="text" id="D_middle" placeholder="Middle Name" required >
...
<input name="D_address" pattern="[a-zA-Z][a-zA-Z0-9\s]*" type="text" id="D_address" placeholder="Address" required><br><br>
</label>
<p>
<label>
...
<center>
   <table border="1" cellpadding="0" cellspacing="0" id="resultTable">
          <thead>
            <th class="th" colspan='9'>Appartment</th>
            <tr>
