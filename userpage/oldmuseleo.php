...
<div id="container">
  <div class="sidebar">
    <ul id="nav">
      ...
      <li><a href="userpage.php" class="selected"><i class="fa fa-list-ol fa-fw" aria-hidden="true"></i>&nbsp; Museleo</a></li>
  ...
  <div class="content">
  <div id="dash">
    <h1>New Decease</h1></div>
    <hr>

      <!-- Row -->
              <div id="containeredit">
              <h5>Add New Relatives</h5><br>
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">



<form action="saveoldmuseleo.php" method="get">
 
  <?php
    $result = mysqli_query($mysqli,"SELECT * FROM museleo_table WHERE D_id ='$D_id'");
    while($row = mysqli_fetch_array($result))
    {
        echo"<input type='hidden' name='D_area_number' value='{$row['D_area_number']}' required>";
    echo"<input type='hidden' name='D_slot_number' value='{$row['D_slot_number']}' required>";
    echo"<input type='hidden' name='D_type' value='{$row['D_type']}' required>";

     echo"<label><b>Lastname</b><br>";
    echo"<input type='text' onKeyPress='return ValidateAlpha(event);' placeholder='Lastname' name='D_lastname'  required><br>";

     echo"<label><b>Firstname</b><br>";
    echo"<input type='text' onKeyPress='return ValidateAlpha(event);' placeholder='Firstname' name='D_firstname'  required><br><br>";

     echo"<input type='text' onKeyPress='return ValidateAlpha(event);'  placeholder='Middle Name' id='middle' name='D_middle'  required>";

  echo"<select name='D_extension_name'  id='senior'>
 ...
 <option value='V'>V</option>
    ...
    echo"<input type='text' name='D_address' placeholder='Barangay,City,Province' required><br>";
     echo"<label><b>Date Of Birth</b><br>";
    echo"<input type='date'  placeholder='yyyy-mm-dd' name='D_dateofbirth' required><br>";
   echo"<label><b>Date Of Death</b><br>";
    echo"<input type='date' placeholder='yyyy-mm-dd' name='D_dateofdeath' required><br>";
    echo"<br>";
    
    echo"<div class='clearfix'>";
    echo"<button type='submit' class='signupbtn'>Add</button>";
    echo"</div>";
    }
    ?>
  </div>
