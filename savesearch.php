...
<button type="submit" id="print" onclick="printPage()">Print</button>
			<p style = "margin-left:30px; margin-top:50px; font-size:14pt; font-weight:bold;">Musileyo Type</p>
        <div align="right">
...
<?php
					...
					$result = $database->prepare ("SELECT * FROM appartment_table where D_slot_number='$D_slot_number'");
?>
