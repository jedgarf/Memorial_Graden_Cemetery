...
<?php
    include("config.php");
    $D_area_number = $_GET['D_area_number'];
?>
<html>
<head>
...
<form action="saveold.php" method="POST">
 
  <?php
    $result = mysqli_query($mysqli,"SELECT * FROM list WHERE D_area_number ='$D_area_number'");
    while($row = mysqli_fetch_array($result))
    {

    
       echo"<input type='hidden' name='D_area_number' value='{$row['D_area_number']}' required>";
        echo"<input type='hidden' name='D_lot_number' value='{$row['D_lot_number']}' required>";
    ...
    echo"<input type='text' placeholder='Firstname' name='D_firstname'  required><br>";

      echo"<label><b>Middle Initial</b><br>";
    echo"<input type='text' placeholder='Middle' maxlength='2' name='D_middle'  required><br>";
     
    echo"<label><b>Address</b><br>";
    echo"<input type='text' name='D_address' required><br>";
     echo"<label><b>Date Of Birth</b><br>";
    echo"<input type='text' pattern='^\d{4}-\d{2}-\d{2}$' maxlength='10' placeholder='yyyy-mm-dd' name='D_dateofbirth' required><br>";
   echo"<label><b>Date Of Death</b><br>";
    echo"<input type='text' pattern='^\d{4}-\d{2}-\d{2}$'  maxlength='10' placeholder='yyyy-mm-dd' name='D_dateofdeath' required><br>";
    echo"<br>";
