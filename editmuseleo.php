...
<form action="updatemuseleo.php" method="POST">
  ...
  <?php
    ...
    echo"<input type='text' onKeyPress='return ValidateAlpha(event);' placeholder='Lastname' name='D_lastname' value='{$row['D_lastname']}' required><br>";

     echo"<label><b>Firstname</b><br>";
    echo"<input type='text' placeholder='Firstname' name='D_firstname' value='{$row['D_firstname']}' required><br>";

      echo"<label><b>Middle Initial</b><br>";
    echo"<input type='text' placeholder='Middle' maxlength='2' name='D_middle' value='{$row['D_middle']}' required><br>";
