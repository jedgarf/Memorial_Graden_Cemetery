...
<?php
    ...
    if(isset($_POST['search']))
    {
        ...
        $query = "SELECT * FROM users WHERE username LIKE '%".$valueToSearh."%'";
...
<div id="container">
  ...
  <?php
   ...
   echo"<input type='text'  name='firstname' value='{$row['firstname']}' required> <hr>";
    ...
    <br>
    <a href="adminpassword.php">Change Paasword?</a>
...
<br><br>
   <div class="warning2">
   <center>
<h2 class="note">Note:<span class="warning">Warning if you change/update your<br>   info its automatically logout!!</span></h2>
      </center></div> 
      </div> 
