...
<div class="print">
  ...
  <div id="openModal1" class="modalDialog1">
              ...
              <a href="#close1" title="Close" class="close1">X</a>
               ...
               <form id="add" name="add" method="get" action="saveareafamily.php">
 ...
 <div class="text">
   <input name="a_number" maxlength="2" onkeypress="return isNumberKey(event)" type="text" id="a_number" placeholder="Area No" required></div><br><br>
              ...
              <a href="#close18" title="Close" class="close18">X</a>
               ...
               <center>
               <form id="add"  name="add" method="get" action="saveslotfamily.php">
...
<div class="styled-select">
 ...
 <div class="text">
   <input name="s_number" maxlength="4" onkeypress="return isNumberKey(event)"  type="text" id="s_number" placeholder="Slot No" required></div><br><br>
                  <p>
                <label>
                <center>
...
<!-- The Modal -->
                ...
                <div>
                <h2 class="headerarea">family Lot</h2>
...
<center>
   <table border="1" cellpadding="0" cellspacing="0" id="resultTable">
          <thead>
            <th class="th" colspan='8'>Family Lot</th>
            <tr>
...
echo "<td><a href='editfamily.php?D_id=".$row['D_id']."' style='text-decoration:none' class='link3' ><i class='fa fa-edit fa-fw' aria-hidden='true'></i></a></td>";
