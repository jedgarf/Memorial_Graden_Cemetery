...
$sql = "UPDATE museleo_table SET D_lastname='$D_lastname',D_dateofbirth='$D_dateofbirth',D_dateofdeath='$D_dateofdeath', D_firstname='$D_firstname', D_type='$D_type', D_address='$D_address', D_middle='$D_middle'
WHERE D_id='$D_id'";
