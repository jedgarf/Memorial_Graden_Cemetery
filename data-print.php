...
<button type="submit" id="print" onclick="printPage()">Print</button>
			<p style = "margin-left:30px; margin-top:50px; font-size:14pt; font-weight:bold;">All Records</p>
        <div align="right">
...
<?php
					...
					$result = $database->prepare ("SELECT * FROM list order by D_lot_number DESC");
?>
...
?>
							<tr>
								...
								<td style="text-align:center;"><?php echo $row_member['D_lot_number']; ?></td>
