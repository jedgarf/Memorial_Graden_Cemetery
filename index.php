...
<head>
  <meta charset="UTF-8">
  <title>
  Memorial Garden Login Form</title>
...
.name{
	...
	width: 1200px;
	height: 100px;
	  background-color: rgba(9, 11, 35, 0.5);
	border-radius: 10px;
...
<body>
  ...
  <br>
  <div class="name">
  <h2>Gapan Memorial Garden Directory Information System</h2>
  </div>
		...
		<form action="authenticate.php" method="POST">
			<h1>Login Form</h1>
			 ...
			 <?php 
                                ...
                                $errors = array(
                                    1=>"<span style='color: red'>Invalid user name or password, Try again </span>",
                                    2=>"<span style='color: red'>Please login to access this area  </span>"
                                  );
...
<div align="left">
	...
	<a href="forgot_password.php"><label style="margin-left: 100px;">Forgot Password?</label></a>
</div>
			<div>
